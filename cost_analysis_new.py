...
Dk =  [100000, 130000]  # --> Demand Produk 
Cppi = [135000, 150000] # --> Kapasitas Maksimal Produksi Manufaktur
Cri = [88000, 92000]      #--> Kapasitas Maksimal Remanufaktur
CPdj = [50000, 60000]     #--> Kapasitas Maksimal Distributor
Cccl = [70000, 95000]     #--> Kapasitas Maksimal Pusat Pengumpulan
Ccdm = [80000, 100000]   #--> Kapasitas Maksimal Pusat Pembuangan

# Fixed Cost
fcl = [400000, 500000]  #--> Biaya Pendirian Fasilitas Pengumpulan
fbm = [300000, 350000]  #--> Biaya Pendirian Fasilitas Pembuangan

# Variable Cost
Coj = [5, 8]              #--> Biaya Penanganan Produk di Distributor 
Ccl = [13, 17]          #--> Biaya Pemilahan Produk di Pengumpulan
Crei = [8, 13]           #--> Biaya Remanufaktur di Pemanufaktur
Cdl = [10, 14]          #--> Biaya Pemusnahan di Pembuangan

PCi = [12.5, 19.5]  #--> Biaya Produksi Non Hijau
...
B = [0.1, 0.3]              #--> Faktor Biaya Produksi Green
Pngi = [50, 55]     #--> Harga Produk Non-Green
Png = [55, 55]      #--> Maksimum Harga Produk Non-Green
Pd = [0, 55]        #--> Maksimum Penawaran Diskon
Fd = [0.5, 0.5]   #--> Proporsi Produk Bekas Pakai Yang Dibuang
q = [0.3, 0.5]   #--> Tingkat Penerimaan Kualitas Produk Bekas Pakai (Menghitung Yk)
a = [0, 10]            #--> Tingkat Kesadaran Lingkungan Konsumen Berdasarkan Zona
...
problem += lp.lpSum(totalcost),"Total Cost :"
